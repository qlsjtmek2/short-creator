...
export default function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  const [activeTab, setActiveTab] = useState<
    'general' | 'ai' | 'canvas' | 'text' | 'effects' | 'audio'
  >('general');
  const [settings, setSettings] = useState({
    // General
    defaultProvider: 'pexels', // Pexels가 가장 안정적
    mockTtsSpeed: 1.0,
          ...
          {activeTab === 'ai' && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                />
                <p className="text-xs text-zinc-500">
                  * 높을수록 창의적이고 예측 불가능한 답변. 낮을수록 일관되고
                  정확한 답변. (0.0 ~ 2.0)
                </p>
              </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          titleMaxLength: parseInt(e.target.value),
                        })
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          sentenceCount: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          sentenceMaxLength: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          letterboxTop: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          letterboxBottom: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <ColorPicker
                    ...
                    onChange={(color) =>
                      setSettings({ ...settings, titleFontColor: color })
                    }
                  />
                  <ColorPicker
                    label="강조 색상"
                    ...
                    onChange={(color) =>
                      setSettings({ ...settings, titleHighlightColor: color })
                    }
                  />
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          titleBorderWidth: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <ColorPicker
                    ...
                    onChange={(color) =>
                      setSettings({ ...settings, titleBorderColor: color })
                    }
                  />
                  <div className="space-y-2">
                    <label className="text-sm text-zinc-300">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          titleMaxCharsPerLine: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          titleLineSpacing: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleOutline: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleShadow: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleMarginV: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleMaxCharsPerLine: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleAlignment: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            subtitleWrappingEnabled: e.target.checked,
                          })
                        }
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleMarginL: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleMarginR: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleSafetyPadding: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleMaxScalePercent: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleFallbackCharsPerLine: parseInt(
                            e.target.value,
                          ),
                        })
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitlePopInDuration: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleScaleUpStart: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleScaleUpEnd: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleScaleDownStart: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleScaleDownEnd: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          subtitleFinalScale: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          kenBurnsStartZoom: parseFloat(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          kenBurnsEndZoom: parseFloat(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          kenBurnsZoomIncrement: parseFloat(e.target.value),
                        })
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          kenBurnsFps: parseInt(e.target.value),
                        })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors"
                    />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm text-zinc-300">
                    <label>TTS 볼륨</label>
                    <span className="font-mono text-purple-400">
                      {settings.ttsVolume?.toFixed(2) || '1.00'}
                    </span>
                  </div>
                  <input
                    type="range"
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm text-zinc-300">
                    <label>BGM 볼륨</label>
                    <span className="font-mono text-purple-400">
                      {settings.bgmVolume?.toFixed(2) || '0.10'}
                    </span>
                  </div>
                  <input
                    type="range"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSettings({ ...settings, preset: e.target.value })
                      }
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500 transition-colors text-white"
                    >
